...
const FIELD_LABELS: Record<string, string> = {
  ...
  "phones.defaultAccountId": "Default Phone Account",
  "phones.accounts": "Phone Accounts",
  "phones.accounts.*.name": "Phone Name",
  "phones.accounts.*.enabled": "Enable Phone",
  "phones.accounts.*.deviceId": "Device ID",
  "phones.accounts.*.deviceType": "Device Type",
  "phones.accounts.*.runtime.provider": "Phone Runtime Provider",
  "phones.accounts.*.runtime.apiUrl": "Phone Runtime API URL",
  "phones.accounts.*.runtime.uiUrl": "Phone Runtime UI URL",
  "phones.accounts.*.runtime.timeoutMs": "Phone Runtime Timeout (ms)",
  "phones.accounts.*.model.baseUrl": "Phone Model Base URL",
  "phones.accounts.*.model.model": "Phone Model",
  "phones.accounts.*.model.apiKey": "Phone Model API Key",
  "phones.accounts.*.model.monitorBaseUrl": "Phone Monitor Base URL",
  "phones.accounts.*.model.monitorModel": "Phone Monitor Model",
  "phones.accounts.*.model.monitorApiKey": "Phone Monitor API Key",
  "phones.accounts.*.defaults.mode": "Phone Mode",
  "phones.accounts.*.defaults.lang": "Phone Language",
  "phones.accounts.*.defaults.maxSteps": "Phone Max Steps",
  "phones.accounts.*.defaults.maxRounds": "Phone Max Rounds",
  "phones.accounts.*.defaults.executorMaxSteps": "Phone Executor Max Steps",
  "phones.accounts.*.defaults.monitorUseScreenshot": "Phone Monitor Screenshot",
  ...
  "tools.web.search.exa": "Exa Search",
  "tools.web.search.exa.apiKey": "Exa API Key",
  "tools.web.search.exa.apiKeys": "Exa API Keys",
  "tools.web.search.exa.baseUrl": "Exa Base URL",
  "tools.web.search.exa.searchType": "Exa Search Type",
  "tools.web.search.exa.contentMode": "Exa Content Mode",
  "tools.web.search.exa.maxCharacters": "Exa Max Characters",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "phones.defaultAccountId": "Default phone account id used when gateway calls omit accountId.",
  "phones.accounts": "Phone account entries keyed by account id.",
  "phones.accounts.*.name": "Human-friendly phone/account label for UI surfaces.",
  "phones.accounts.*.enabled": "When false, the account stays listed but phone.run is blocked.",
  "phones.accounts.*.deviceId": "Preferred device id/serial for the runtime adapter.",
  "phones.accounts.*.deviceType": 'Device transport type (currently "adb" for auto_glm).',
  "phones.accounts.*.runtime.provider": 'Runtime adapter id (currently "autoglm").',
  "phones.accounts.*.runtime.apiUrl":
    "Direct runtime API base URL. If omitted, uiUrl is used and /api is appended.",
  "phones.accounts.*.runtime.uiUrl": "Optional human-facing runtime Web UI URL.",
  "phones.accounts.*.runtime.timeoutMs": "Timeout in ms for runtime HTTP calls.",
  "phones.accounts.*.model.baseUrl": "Executor model base URL passed to the runtime.",
  "phones.accounts.*.model.model": "Executor model name passed to the runtime.",
  "phones.accounts.*.model.apiKey": "Executor model API key passed to the runtime.",
  "phones.accounts.*.model.monitorBaseUrl": "Monitor model base URL for mode=monitor.",
  "phones.accounts.*.model.monitorModel": "Monitor model name for mode=monitor.",
  "phones.accounts.*.model.monitorApiKey": "Monitor model API key for mode=monitor.",
  "phones.accounts.*.defaults.mode": 'Default execution mode ("direct" or "monitor").',
  "phones.accounts.*.defaults.lang": "Default language hint passed to the runtime.",
  "phones.accounts.*.defaults.maxSteps": "Default executor max_steps value.",
  "phones.accounts.*.defaults.maxRounds": "Default monitor max_rounds value.",
  "phones.accounts.*.defaults.executorMaxSteps": "Default executor burst length when mode=monitor.",
  "phones.accounts.*.defaults.monitorUseScreenshot":
    "Default monitor screenshot toggle when mode=monitor.",
  ...
  "tools.web.search.exa.apiKeys":
    "Exa API keys pool (fallback: EXA_API_KEYS env var, comma-separated).",
  "tools.web.search.exa.baseUrl": "Exa base URL override (default: https://api.exa.ai).",
  "tools.web.search.exa.searchType": 'Exa search type override (default: "auto").',
  "tools.web.search.exa.contentMode": 'Exa content mode override (default: "highlights").',
  "tools.web.search.exa.maxCharacters": "Max characters for Exa returned content (default: 4000).",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "phones.accounts.*.deviceId": "emulator-5554",
  "phones.accounts.*.runtime.apiUrl": "http://127.0.0.1:8001/api",
  "phones.accounts.*.runtime.uiUrl": "http://127.0.0.1:8001",
  "phones.accounts.*.model.baseUrl": "http://127.0.0.1:8000/v1",
  "phones.accounts.*.model.model": "autoglm-phone",
