...
export const OneBotAiKpConfigSchema = z
  .object({
    ...
    activationRouterEnabled: z.boolean().optional(),
    activationRouterProvider: z.string().optional(),
    activationRouterModel: z.string().optional(),
    activationRouterAuthProfileId: z.string().optional(),
    activationRouterMaxTokens: z.number().int().positive().optional(),
    activationRouterTimeoutMs: z.number().int().positive().optional(),
